...
Type: :py:class:`~otupy.profiles.xbom.data.peer.Peer` (:py:class:`~otupy.types.base.record.Record`)
...
.. list-table::
   ...
   * - 2
     - role
     - :py:class:`~otupy.profiles.xbom.data.peer_role.PeerRole`
     - 1
     - Role of this peer in the link.
   * - 3
     - consumer
     - :py:class:`~otupy.profiles.xbom.data.consumer.Consumer`
     - 1
