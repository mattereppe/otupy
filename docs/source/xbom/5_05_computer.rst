...
Type: :py:class:`~otupy.profiles.xbom.data.computer.Computer` (:py:class:`~otupy.types.base.record.Record`)
...
.. list-table::
   ...
   * - 4
     - os
     - :py:class:`~otupy.profiles.xbom.data.os.OS`
     - 1
     - Operating systems installed on the computer.
   * - 5
     - apps
     - :py:class:`~otupye.types.base.array_of.ArrayOf`\(:py:class:`~otupy.profiles.xbom.data.application.Application`
     - 1
