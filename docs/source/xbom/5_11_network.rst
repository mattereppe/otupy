...
Type: :py:class:`~otupy.profiles.xbom.data.network.Network` (:py:class:`~otupy.types.base.record.Record`)
...
.. list-table::
   ...
   * - 3
     - type
     - :py:class:`~otupy.profiles.xbom.data.network_type.NetworkType`
     - 1
