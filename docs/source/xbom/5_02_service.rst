...
Type: :py:class:`~otupy.profiles.xbom.data.service.Service` (:py:class:`~otupy.types.base.record.Record`)
...
.. list-table::
   ...
   * - 2
     - type
     - :py:class:`~otupy.profiles.xbom.data.service_type.ServiceType`
     - 1
