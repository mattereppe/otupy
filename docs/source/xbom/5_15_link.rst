...
Type: :py:class:`~otupy.profiles.xbom.data.link.Link` (:py:class:`~otupy.types.base.record.Record`)
...
.. list-table::
   ...
   * - 1
     - name
     - :py:class:`~otupy.profiles.xbom.data.name.Name`
     - 1
     - Id of the link.
   * - 2
     - desc
   ...
   * - 4
     - link_type
     - :py:class:`~otupy.profiles.xbom.data.link_type.LinkType`
     - 1
     - Type of the link.
   * - 5
     - peers
     - :py:class:`~otupy.types.base.array_of.ArrayOf`\(:py:class:`~otupy.profiles.xbom.data.peer.Peer`)
     - 1
