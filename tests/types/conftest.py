...
def start_container_ext_noprofile():
	return oc2.Command(action=oc2.Actions.query, target=acme_noprofile.Container({"container_id": "E57C0116-D291-4AF3-BEF9-0F5B604A2C85"}))

@pytest.fixture
def start_container_ext_specialchar1():
	return oc2.Command(action=oc2.Actions.query, target=acme_specialchar1.Container({"container_id": "E57C0116-D291-4AF3-BEF9-0F5B604A2C85"}))

@pytest.fixture
def start_container_ext_specialchar2():
	return oc2.Command(action=oc2.Actions.query, target=acme_specialchar2.Container({"container_id": "E57C0116-D291-4AF3-BEF9-0F5B604A2C85"}))

@pytest.fixture
def start_container_ext_underscore_first1():
	return oc2.Command(action=oc2.Actions.query, target=acme_underscore_first1.Container({"container_id": "E57C0116-D291-4AF3-BEF9-0F5B604A2C85"}))

@pytest.fixture
def start_container_ext_underscore_first2():
	return oc2.Command(action=oc2.Actions.query, target=acme_underscore_first2.Container({"container_id": "E57C0116-D291-4AF3-BEF9-0F5B604A2C85"}))
