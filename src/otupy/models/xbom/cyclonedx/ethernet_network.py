...
from otupy.models.ctxd.ethernet_network import EthernetNetwork
...
def to_cyclonedx(self) -> Service:
	...
	if nets is not None:
		for i, net in enumerate(nets):
			net_props = net.to_cyclonedx(prefix=f"otupy:ethernet:{i}")
...
EthernetNetwork.to_cyclonedx = to_cyclonedx
