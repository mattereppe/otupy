...
class SQLDatabase:
    ...
    def insert_command(self, insert_rule, action, drop_process, direction, target, protocol, src_addr, src_port, dst_addr, dst_port, start_time, stop_time, persistent, custom_data, scheduler_data):
        ...
        try:
            ...
            c.execute(f'''INSERT INTO {self.commands_table_name} 
                          (rule_number, action, drop_process, direction, target, protocol, src_addr, src_port, dst_addr, dst_port, start_time, stop_time, persistent, custom_data, scheduler_data) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)''',
                            (insert_rule, action, drop_process, direction, target, protocol, src_addr, src_port, dst_addr, dst_port, start_time, stop_time, persistent, custom_data_blob, scheduler_data_blob))
