...
from otupy.profiles.ctxd.data.service import Service, ServiceType, Link 


logger = logging.getLogger(__name__)

@actuator_implementation("ctxd-file")
class CTXDActuator_file(CTXDActuator):
	""" File Actuator Manager

		Extend the base `CTDXActuator` to retrieve services and links from a file
