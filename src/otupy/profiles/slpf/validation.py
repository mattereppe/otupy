...
AllowedCommandTarget[Actions.allow] = [
    TargetEnum.ipv4_connection,
    TargetEnum.ipv6_connection,
    TargetEnum.ipv4_net,
    TargetEnum.ipv6_net,
]
AllowedCommandTarget[Actions.deny] = [
    TargetEnum.ipv4_connection,
    TargetEnum.ipv6_connection,
    TargetEnum.ipv4_net,
    TargetEnum.ipv6_net,
...
AllowedCommandArguments = fillin_allowed_command_arguments(
    AllowedCommandArguments, Actions.allow, AllowedCommandTarget[Actions.allow], args
)
AllowedCommandArguments = fillin_allowed_command_arguments(
    AllowedCommandArguments, Actions.deny, AllowedCommandTarget[Actions.deny], args
)
AllowedCommandArguments[(Actions.query, TargetEnum.features)] = ["response_requested"]
AllowedCommandArguments[(Actions.delete, TargetEnum[Profile.nsid + ":rule_number"])] = [
    "response_requested",
    "start_time",
]
