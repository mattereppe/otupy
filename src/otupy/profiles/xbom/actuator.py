""" XBOM profile
	...
	This modules contains the definition of the `xbom` profile. It is mostly used as a container
...
class Specifiers(oc2.Map):
	""" XBOM Specifiers
		...
		Define the set of specifiers defined in this specification that are meaningful in the context of XBOM.
