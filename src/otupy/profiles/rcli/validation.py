...
AllowedCommandArguments[(Actions.start, TargetEnum[Profile.nsid + ":processes"])] = [
    "response_requested",
    "start_time",
    "stop_time",
    "duration",
]
AllowedCommandArguments[(Actions.stop, TargetEnum[Profile.nsid + ":processes"])] = [
    "response_requested",
    "stop_time",
    "duration",
]
AllowedCommandArguments[(Actions.delete, TargetEnum[Profile.nsid + ":files"])] = [
    "response_requested",
]
