""" 
	...
	- ``services``: A list of "root services" to query, indicated as their :py:class:`~otupy.profiles.xbom.data.consumer.Consumer` endpoints:
	...
	A template configuration file is available `here <https://github.com/mattereppe/otupy/blob/main/src/otupy/apps/xbom/discovery.yaml.template>`__.
