...
from otupy.apps.xbom.api_service import api_listen
from otupy.apps.xbom.discover_functions import start_discovery
from otupy.apps.xbom.defaults import parse_and_default
...
def main() -> None:
	...
	logging.info("Starting OpenC2 Context Discovery Service, api mode: %s", str(args.api))
	if args.api:
