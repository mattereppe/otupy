...
""" Extensions
	...
	This is the registry that keeps track of all extensions to the core openc2lib data and
	structures. 
"""
...
def extension(nsid):
	""" @extends decorator
		...
		@return: The class definition that is now registered and usable in openc2lib.
	"""
