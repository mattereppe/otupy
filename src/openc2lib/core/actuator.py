...
from openc2lib.core.extensions import Extensions, Register
...
def actuator(nsid):
	""" The `@actuator` decorator
		...
		Use this decorator to declare an `Actuator` in openc2lib extensions.
		:param nsid: The Profile NameSpace identifier (must be the same as defined by the corresponding Profile specification.
		:result: The following class definition is registered as valid `Actuator` in openc2lib.
	"""
