...
AllowedCommandArguments[(Actions.start, TargetEnum[Profile.nsid+':monitor'])] = ['response_requested', 'start_time', 'stop_time',  'duration', 'log_exporter','export_fields', 'import_controls']
