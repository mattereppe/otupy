""" File Collection Log Monitor

	This modules contains the definition of the `fclm` profile.
"""
...
""" FCLM Specifiers
	...
	Define the set of specifiers defined in this specification that are meaningful in the context of FCLM.
