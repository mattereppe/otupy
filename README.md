...
[comment]: <> User documentation of the openc2lib is available [here](docs/code/index.html).
User documentation of the openc2lib code can be generated by running the following command in the root tree:
```
