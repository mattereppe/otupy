...
from helpers import load_cbor, load_files, send_raw_command
...
command_path_good = "../../openc2-cbor-samples/tests/commands/good"
command_path_bad = "../../openc2-cbor-samples/tests/commands/bad"
...
def test_sending(cmd, create_cbor_producer, caplog):
