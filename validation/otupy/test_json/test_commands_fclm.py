...
from openc2lib.profiles.fclm.data.transfer import Transfer
...
import json_schema_validation_fclm
import acme
...
command_path_good = "../../openc2-json-schema/tests/commands/good/fclm"
command_path_bad = "../../openc2-json-schema/tests/commands/bad/fclm"
...
# WARNING: the visible logs are those generated within this function. Everything else in the fixture does not produce logs
	...
	print(req)
	print(rsp)
	#json_schema_validation_fclm.validate_http(req, json_schema_validation_fclm.Validation.base)
	json_schema_validation_fclm.validate_http(req, json_schema_validation_fclm.Validation.contrib)
	#json_schema_validation_fclm.validate_http(rsp, json_schema_validation_fclm.Validation.base)
	json_schema_validation_fclm.validate_http(rsp, json_schema_validation_fclm.Validation.contrib)
