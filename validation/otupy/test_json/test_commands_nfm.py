...
from openc2lib.profiles.nfm.data.transfer import Transfer
...
import json_schema_validation_nfm
...
command_path_good = "../../openc2-json-schema/tests/commands/good/nfm"
command_path_bad = "../../openc2-json-schema/tests/commands/bad/nfm"
...
# WARNING: the visible logs are those generated within this function. Everything else in the fixture does not produce logs
	...
	print(req)
	print(rsp)
	#json_schema_validation_nfm.validate_http(req, json_schema_validation_nfm.Validation.base)
	json_schema_validation_nfm.validate_http(req, json_schema_validation_nfm.Validation.contrib)
	#json_schema_validation_nfm.validate_http(rsp, json_schema_validation_nfm.Validation.base)
	json_schema_validation_nfm.validate_http(rsp, json_schema_validation_nfm.Validation.contrib)
