...
@pytest.mark.parametrize(
    "parent", [Process({"name": "parent", "pid": 0, "cwd": "/var/run", "command_line": "/usr/bin/run"})]
)
    ...
    random_params(
        {
            ...
            "pid": 45,
            "cwd": "/var/run/process",
            "executable": {"name": "/usr/local/bin/executable.exe"},
            "parent": {"name": "parent", "pid": 0, "cwd": "/var/run", "command_line": "/usr/bin/run"},
            "command_line": "usr/local/bin/executable.exe -a param1 -b param2",
        }
    ),
)
