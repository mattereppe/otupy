...
from openc2lib.actuators.rcli.rcli_actuator import RCLIActuator
...
# Add file logger
file_handler = logging.FileHandler("server_rcli_query_features.log")
...
# is the assed_id of the actuator.
	actuators = {}
	actuators[(rcli.Profile.nsid,'x-rcli')]=RCLIActuator()
