...
#    arg = slpf.Args({'persistent': 0})
    ...
    arg = slpf.Args({'start_time': oc2.DateTime((time.time() + 40) * 1000)})
...
#    cmd = oc2.Command(oc2.Actions.allow, oc2.IPv4Connection(dst_addr=oc2.IPv4Net("192.168.0.209")), arg, actuator=pf)  # OpenStack
#    cmd = oc2.Command(oc2.Actions.allow, oc2.IPv4Connection(dst_addr=oc2.IPv4Net("10.17.2.118")), arg, actuator=pf)  # Kubernetes
...
#    cmd = oc2.Command(oc2.Actions.deny, oc2.IPv4Net("10.0.2.0/24"), arg, actuator=pf)
    # deny IPv6Net
